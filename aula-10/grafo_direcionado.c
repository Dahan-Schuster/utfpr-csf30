...
int main () {
   ...
   inserir_arestas_adj(Ga, 0, 1);
   inserir_arestas_adj(Ga, 0, 5);
   inserir_arestas_adj(Ga, 1, 2);
   inserir_arestas_adj(Ga, 1, 3);
   inserir_arestas_adj(Ga, 2, 0);
   inserir_arestas_adj(Ga, 2, 4);
   inserir_arestas_adj(Ga, 3, 2);
   inserir_arestas_adj(Ga, 4, 3);
   inserir_arestas_adj(Ga, 5, 4);
   ...
   inserir_arestas_mat(Gm, 2, 0);
   inserir_arestas_mat(Gm, 2, 4);
   inserir_arestas_mat(Gm, 3, 2);
   inserir_arestas_mat(Gm, 4, 3);
   inserir_arestas_mat(Gm, 5, 4);
